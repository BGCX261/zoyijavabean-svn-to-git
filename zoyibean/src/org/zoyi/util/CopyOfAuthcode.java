...
public class CopyOfAuthcode {
	...
	public static void main(String[] args) {
		String test = "fire";
		String key = "123456";
		String afStr = CopyOfAuthcode.authcodeEncode(test, key);
		System.out.println("--------encode:" + afStr);
		//String deStr = Authcode.authcodeDecode("66afE5LwHoO2JNQ3P9OqTsgNv07OZSfylhACahWUgOafwdJJ%2FUadZJ1pbhEKwrU9lOsGSnoHAV8tZdM0OGGT", key);
