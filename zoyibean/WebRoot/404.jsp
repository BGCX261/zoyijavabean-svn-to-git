...
<meta http-equiv="refresh" content="888; URL=index.php" />
<title>众益网</title>
...
<f:view>
	...
	<table width="970" border="0" cellspacing="0" cellpadding="40">
		<tr>
			...
			<h3><h:outputLink onclick="history.back();"><h:graphicImage alt="您要访问的资源不存在，请点击图片后退" url="images/noresourse.jpg"/></h:outputLink> </h3>
			<h3>888秒后自动跳转到<h:outputLink value="index.php">主页！</h:outputLink></h3>
			<h3><h:outputLink onclick="history.back();">如果要后退请点击这里。</h:outputLink></h3>
			</th>
		</tr>
	</table>
