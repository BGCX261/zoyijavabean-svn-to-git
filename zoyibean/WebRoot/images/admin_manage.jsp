...
<f:view>
	...
	<dl>
		<table>
			<tr>
				...
				<dt><h:outputLink value="admin_manage_activityusercredit.php">活动积分管理</h:outputLink></dt>
				<dt><h:outputLink value="admin_manage_announcement.php">通知管理</h:outputLink></dt>
				<dt><h:outputLink value="admin_manage_user.php">用户管理</h:outputLink></dt>
				</td>
				<td>
				<dt><h:outputLink value="admin_manage_admin.php">Admin管理</h:outputLink></dt>
	...
	<br />
	<h:form><h:commandLink action="#{adminmodelbean.logout}">注销</h:commandLink></h:form>
    </div>
	</div>
