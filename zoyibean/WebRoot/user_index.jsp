...
<f:view>
	...
	<div class="location">您的位置：首页 -&gt; 他的公益</div>
		...
		<tr>
			...
			<table width="520" border="0" cellspacing="0" cellpadding="3">
				<tr>
					...
					<td width="80" align="left" valign="middle" class="tdtitle"><h:outputText
						value="#{usermodelbean.userinfo.name}" /></td>
				</tr>
				<tr>
					<td colspan="2">
					<div class="tdcon"><span>性别：</span><h:outputText
						value="#{usermodelbean.userinfo.gender}" /></div>
					<div class="tdcon"><span>生日：</span><h:outputText
						value="#{usermodelbean.userinfo.birthday}" ><f:convertDateTime pattern="yyyy年MM月dd日"/></h:outputText></div>
					<div class="tdcon"><span>家乡：</span><h:outputText
						value="#{usermodelbean.userinfo.birthProvince}" /><h:outputText
						value="#{usermodelbean.userinfo.birthCity}" /></div>
					</td>
				</tr>
				...
				<tr>
					...
					<div class="tdcon"><span style="margin-left: 35px">email：</span><h:outputText
						value="#{usermodelbean.userinfo.email}" /></div>
					<div class="tdcon"><span style="margin-left: 5px">个人网站：</span><h:outputText
						value="#{usermodelbean.userinfo.index}" /></div>
					</td>
				</tr>
			</table>
			<h:outputLink target="_blank"
				value="http://localhost/cq/home/cp.php">详细信息</h:outputLink></div>
			<div id="annoucement">
			...
			<div id="duiying_con">信用查看</div>
			<div id="duiyingxinxi" style="padding: 5px 0 20px">
			<p>累积信用：<h:outputText value="#{usermodelbean.userinfo.credit}" /></p>
			<br />
