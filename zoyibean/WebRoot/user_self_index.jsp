	...
	<table width="960" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<table width="520" border="0" cellspacing="0" cellpadding="3">
				<tr>
					<td width="430" align="left" class="tdtitle"><h:outputText
						value="#{sessionScope.zoyiUser.username}" />基本信息</td>
					<td width="80" align="left" valign="middle" class="tdtitle"><img
						src="images/editicon.gif" width="16" height="16" /><h:form>
						<h:outputLink value="http://localhost/cq/home/cp.php">
							编辑资料</h:outputLink>
					</h:form></td>
				</tr>
				<tr>
					<td colspan="2">
					<div class="tdcon"><span>姓名：</span><h:outputText
						value="#{sessionScope.zoyiUser.name}" /><span>性别：</span><h:outputText
						value="#{sessionScope.zoyiUser.gender}" /></div>
					<div class="tdcon"><span>Email：</span><h:outputText
						value="#{sessionScope.zoyiUser.email}" /></div>
					<div class="tdcon"><span>生日：</span><h:outputText
						value="#{sessionScope.zoyiUser.birthday}" ><f:convertDateTime pattern="yyyy年MM月dd日"/></h:outputText><span>家乡：</span><h:outputText
						value="#{sessionScope.zoyiUser.birthProvince}" /><h:outputText
						value="#{sessionScope.zoyiUser.birthCity}" /></div>
					</td>
				</tr>
				...
				<tr>
					...
					<div class="tdcon"><span style="margin-left: 5px">个人网站：</span><h:outputText
						value="#{sessionScope.zoyiUser.index}" /></div>
					</td>
				</tr>
			</table>
			<h:outputLink
				value="http://localhost/cq/home/space.php?uid=#{userinfobean.userinfo.userId }">详细信息</h:outputLink></div>
			<div id="annoucement">
