...
<f:view>
	...
	<table width="960" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td valign="top">
			<div id="tishi2"><h:form>
				<table align="left">
					<tr>
						<td><h:outputLabel value="可接受人数：" /><h:inputText
							value="#{benifitActivity.limitnum }" /></td>
					</tr>
					<tr>
						<td><h:outputLabel value="活动名称：" /><h:inputText
							value="#{benifitActivity.activityName}" /></td>
					</tr>
					<tr>
						<td><h:outputLabel value="活动地点：" /><h:inputText
							value="#{benifitActivity.location }" /></td>
					</tr>
					<tr>
						<td><h:outputLabel value="活动截止申请日期：" /> <rich:calendar
							id="applyDeadline" value="#{benifitActivity.deadline }"
					...
					<tr>
						<td><h:outputLabel value="活动开始时间：" /><rich:calendar
							value="#{benifitActivity.starttime}" cellWidth="30px"
							cellHeight="30px" datePattern="yyyy-MM-dd HH:mm" popup="true"
							locale="cn" /></td>
					</tr>
					<tr>
						<td><h:outputLabel value="活动结束时间：" /><rich:calendar
							value="#{benifitActivity.endtime}" cellWidth="30px"
							cellHeight="30px" datePattern="yyyy-MM-dd HH:mm" popup="true"
							locale="cn" /></td>
					</tr>
					<tr>
						<td><h:outputLabel value="活动性质：" /><h:inputText
							value="#{benifitActivity.benifitActivityCategory.id}" /></td>
					</tr>
					<tr>
						<td><h:outputLabel value="工作描述：" /> <FCK:editor
							instanceName="workDescription" width="550" height="550">
							<jsp:attribute name="value">
			<c:out value="${param.workDescription}" escapeXml="false" />
		</jsp:attribute>
							<jsp:body>
			<FCK:config />
		</jsp:body>
					...
					<tr>
						<td><h:outputLabel value="picture" /><h:inputText
							value="#{benifitActivity.poster }" /></td>
					</tr>
					<tr>
			...
			</h:form> <h:outputLink value="http://localhost/cq/home/cp.php?ac=event">详细信息</h:outputLink></div>
			<div id="annoucement">
