...
<f:view>
	...
	<div class="location">您的位置：首页 -&gt; 公益排行</div>
			...
			<table width="520" border="0" cellspacing="0" cellpadding="3">
				<tr>
					<td width="430" align="center"><h:form>
						<rich:dataTable id="allGroup" width="660" border="0"
							cellspacing="0" cellpadding="4" value="#{groupBean.dataModel}"
							var="group" rows="#{groupBean.pageSize }">
							<rich:column>
								<f:facet name="header">
									<h:outputText value="排名"></h:outputText>
								</f:facet>
								<h:outputText value="#{groupBean.dataModel.rowIndex+1}" />
							</rich:column>
							<rich:column>
								<f:facet name="header">
							...
							<rich:column>
								<f:facet name="header">
									<h:outputText value="会员数"></h:outputText>
								</f:facet>
						...
						<rich:spacer />
						<rich:datascroller for="allGroup" align="left" />
						<rich:spacer />
					</h:form></td>
				</tr>
			</table>
			<h:outputLink target="_blank" value="http://localhost/cq/home/cp.php"></h:outputLink></div>
